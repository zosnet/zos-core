...
namespace fc {
   ...
   namespace raw {
    ...
    template<typename Stream> inline void pack( Stream& s, const unsigned_int64& v, uint32_t _max_depth=FC_PACK_MAX_DEPTH );
    template<typename Stream> inline void unpack( Stream& s, unsigned_int64& vi, uint32_t _max_depth=FC_PACK_MAX_DEPTH );
