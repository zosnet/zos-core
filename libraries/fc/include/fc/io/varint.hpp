...
struct unsigned_int64 {
    ...
    unsigned_int64& operator=( int32_t v ) { value = v; return *this; }
...
void to_variant( const unsigned_int64& var, variant& vo, uint32_t max_depth = 1 );
void from_variant( const variant& var, unsigned_int64& vo, uint32_t max_depth = 1 );
